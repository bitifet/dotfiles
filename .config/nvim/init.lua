...
vim.cmd("so ~/.vim/vimrc_files/editor.vim")

--vim.cmd("so ~/.vim/vimrc_files/plugins.vim")
vim.cmd("so ~/.vim/vimrc_files/colors.vim")

vim.cmd("so ~/.vim/vimrc_files/addons.vim")
vim.cmd("so ~/.vim/vimrc_files/display.vim")
vim.cmd("so ~/.vim/vimrc_files/folding.vim")
vim.cmd("so ~/.vim/vimrc_files/navigation.vim")
vim.cmd("so ~/.vim/vimrc_files/filesystem.vim")
...
vim.cmd("so ~/.vim/vimrc_files/112.vim")
